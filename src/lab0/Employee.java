...
public class Employee {
     ...
     */
    public Employee(String firstName, String lastName, String ssn, int daysVacation) throws Exception {
    ...
    public final void setDaysVacation(int daysVacation) throws IllegalArgumentException{
        ...
        if(daysVacation < 0 || daysVacation > 28) {
            throw new IllegalArgumentException("Days vacation cannot be less than 0 or greater than 28");
        }
    }
    ...
    public final void setSsn(String ssn) throws IllegalArgumentException{
        ...
        throw new IllegalArgumentException("Sorry, ssn should be in xxx-xx-xxxx format or xxxxxxxxx format");
        }
